...
- [`CURRENT_STATE.md`](CURRENT_STATE.md) — кратък моментен образ на това, което се вярва след S02E05.
...
8. **Има преносима телесна аномалия:** Мартин прехвърля към Бойд кръвна/червееподобна аномалия с неизвестни ефекти.
...
10. **Възприятието може да е активен интерфейс:** виденията на Бойд след Мартин поставят въпроса дали perception channels могат да имат физически ефект.
...
13. **Правилата са по-важни от всяка отделна единица.**
