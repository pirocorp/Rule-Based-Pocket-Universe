...
- [`CURRENT_STATE.md`](CURRENT_STATE.md) — кратък моментен образ на това, което се вярва след S03E09.
...
10. **Cicada / Music-Box / Rhyme Threat Subsystem:** sleep е attack surface, не requirement; S02E10 показва stop condition за active three-person captivity instance, но S03E09 Randall продължава да чува cicadas, така че residue/marked-state линията остава жива.
11. **Temporal / Causal Threshold Access:** S03E08 показва Julie да преживява dungeon/Martin/Boyd event-layer и да хвърля въжето към Boyd; S03E09 тя вече настоява, че не е било просто сън. Това е силен self-consistent causal-loop candidate, не свободно time-travel правило.
...
13. **Miranda/Tabitha и Christopher/Jade подсилват role recurrence:** S03E09 качва Miranda-Tabitha линията до силна memory/identity-connection хипотеза, но не доказва буквална роднинска връзка с Victor, time loop, destiny или reincarnation.
...
18. **Fatima Pregnancy / Appetite Anomaly:** вече е pregnancy-like anomalous condition без видим fetus при scan-а, body/craving escalation, physical danger, hidden-room containment, Elgin/source "not yours" claim и active human-blood feeding; без monster-pregnancy или possession заключение.
...
23. **Kimono manifestation вече не е Elgin-only:** Fatima също я вижда, а S03E09 я показва като активен containment/physical-control participant около Fatima.
24. **Convergent information channels:** Sara voices, kimono/Polaroid, children guidance, Thomas voice, Boy in White и Julie threshold access започват да се насочват към общи ключови събития/възли; това е convergence clue, не доказателство за един controller.
