...
След S01E10 инфраструктурата може да се третира и като потенциален **interface**, през който някой или нещо наблюдава/намесва се. Това не доказва външна комуникация.
