...
## Разлагане на правило след S04E10

При system-level събития не записвайте само `input -> outcome`. Разделяйте:

1. **Shared constraint** — кое правило, class restriction или spatial state прави действието възможно?
...
4. **Observed outcome** — какво действително се случва?

Това пази трите различни въпроса отделно: кой действа, кое правило го допуска и как хората могат да променят резултата. Не приемайте, че entity, която използва правило, го е създала или контролира цялата система.
