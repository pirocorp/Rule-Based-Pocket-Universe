...
2. **Observation** — какво е директно показано или изрично казано?
3. **Rule candidate** — кое повтарящо се ограничение може да го обясни?
4. **Evidence** — кои гледани сцени подкрепят кандидата?
5. **Counter-evidence** — какво не пасва?
6. **Confidence** — 1 до 5 звезди.
7. **Open questions** — какво остава неизвестно?
8. **Hypothesis impact** — засилва ли или отслабва по-широк модел?
9. **Repo update gate** — попитайте дали стабилната информация да бъде записана.
10. **ADR update** — само ако архитектурният модел се променя.
