...
### S03E06 data caution
Same-number-set, repeated numbers и mirrored/reversed digits правят Bottle Tree notes по-силно structured-data clue. Това не доказва route code или че числата определят destination-а.

### S03E08 origin caution
Boy in White account-ът свързва Faraway Tree с roots/children origin line-а, но не доказва routing algorithm-а. Това може да е literal origin, mythic account, partial truth или distorted memory. Conditional routing въпросът остава отделен.

### S03E09 preservation caution
Boy in White preservation intervention-ът доказва, че Bottle Tree остава важен system node, дори ако е dangerous/bad tree. Това не доказва защо е важно, дали трябва да се пази за rescue route, или дали Boy in White е надежден.

### S04E03 route-validity caution
S04E03 прави route validity проблема по-силен: Bottle Tree не е lighthouse shortcut, който може механично да се повтори. Дори за Tabitha предупреждението е, че "преди" route-ът е бил валиден, но сега може да не е. Това подкрепя unknown state-/condition-dependent routing, не случайност и не пълен контрол от Boy in White.

## ER-004 — Boy in White Contact Rule
**Наблюдение:** Момчето в бяло се появява на селектирани хора, най-вече Виктор и Итън, и в S01E07 насочва Джули към Дърво на далечината. В S01E10 то действа по-активно: изпраща Виктор към Табита и помага/насочва Бойд и Сара; Сара също го чува. В S02E04 Сара и Бойд обсъждат Момчето в бяло, а Сара казва, че то е различно от обичайните гласове, което подсилва shared/overlapping channel линията и възможното разграничение между източници. В S02E09 Elgin си спомня, че Boy in White повтаря песничката/римата, свързана с music-box/phone/radio threat line. В S02E10 Boy in White бута Tabitha от lighthouse/tower, след което тя се събужда в apparent outside world. В S03E01 Tabitha вижда Boy in White в apparent outside world. В S03E08 Victor си спомня, че Boy in White, не Jasper, е говорил на Christopher и е дал origin/tree instruction account около децата, roots, символа и Faraway Tree. В S03E09 Boy in White спира Victor да отсече Bottle Tree, казва че дървото е лошо, но важно, казва че е опитал с Christopher и че хората трябва да разберат сами, а също твърди, че "everything is changing now". В S04E03 Tabitha и Henry едновременно го виждат/чуват при Bottle Tree, а той предупреждава, че tree route-ът може вече да не я върне до lighthouse-а. В S04E04 той казва, че времето им изтича.
**Увереност:** ⭐⭐⭐⭐☆

### Ограничение
Това подкрепя ролята му като активен навигатор/информационен образ и вече показва active physical/ejection-like intervention. S03E01 отваря въпрос дали каналът му може да достига извън physical FROM boundary, или Tabitha преживява trauma/vision carryover. S04E03 подсилва, че не е чисто personal hallucination, защото Tabitha и Henry го виждат едновременно. S03E08 добавя най-силния му historical/origin payload досега, но не доказва крайните му цели, че е всемогъщо, или че е задължително отделна агенция от всички други канали. Сара го различава от гласовете, но това все още може да е разлика в канал/проявление, не задължително отделна сила. S02E09 доказва достъп до rhyme payload-а, не source/intent. S02E10 не доказва, че "бутането от фара" е универсален изходен механизъм. S03E08 не доказва, че origin account-ът е пълна/надеждна история. S03E09-S04E04 показват, че Boy in White може да пази/коментира опасен node, route conditions и urgency/deadline, без да обяснява механизма; "people need to learn for themselves" и "running out of time" са source claims, не правило, че той винаги е полезен или безсилен.

## ER-005 — Monster Subterranean Habitat Candidate
**Наблюдение:** в S02E01 Виктор казва на Табита, че чудовищата живеят под града. Подземният слой съдържа човешки предмети като куфар, книги, колело, стол и часовник. В S03E06 Victor и Henry влизат там през деня; поне едно чудовище е будно/интерактивно, говори на Victor и го предупреждава, а Henry разпознава предмет на майката на Victor сред вещите.

**Увереност:** ⭐⭐⭐⭐⭐ за подземния habitat; ⭐⭐⭐⭐☆ за дневна подземна активност; ⭐⭐☆☆☆ за функцията на човешките предмети.

### Ограничение
Това подкрепя идеята за подземно местообитание/дневен слой на чудовищата. S03E06 refactor-ва по-ранното предположение: чудовищата може да са под земята през деня, но не е доказано, че спят или са неактивни там. Човешките предмети не доказват сами по себе си, че чудовищата някога са били хора; възможни са и вещи на жертви, предишни жители, взети лични предмети или стар слой на града.
...
**Наблюдение:** в S03E01 чудовищата освобождават животните, които общността използва или планира да използва като храна, и организират капан за Boyd, който изглежда насочен към пречупването му. В S03E02 чудовищата измъчват и убиват Tian-Chen, майката на Kenny, така че Boyd да бъде принуден да гледа. В S03E04 те нарушават/адаптират routine-а около arrival event-а и поставят Boyd в bargain/hostage-like ситуация, използвайки Randall като leverage. В S04E02 до къщата на Tabitha е оставена торба с мъртви кози, което изглежда като staged intimidation/resource attack clue, но source-ът не е доказан. В S04E07 Kenny е target-нат в coordinated ambush около Boyd-овия план, но attribution-ът за plan knowledge минава по-предпазливо през Sophia/Man in Yellow, не през самостоятелно monster omniscience.

**Увереност:** ⭐⭐⭐⭐⭐ за стратегическо поведение; ⭐⭐⭐⭐☆ за psychological-warfare reading; ⭐⭐☆☆☆ за пълния им достъп до човешки планове.

### Ограничение
Това доказва способност за multi-step planning: животните са хранителен ресурс; хората не могат лесно да ги изгубят; ако животните бъдат пуснати през нощта, хората ще бъдат примамени навън. S03E02 добавя personalized psychological warfare: те не просто убиват Tian-Chen, а използват смъртта и страданието й като инструмент срещу Boyd. S03E04 добавя social/choice manipulation: чудовищата могат да използват hostage-like leverage, размяна или условие, а не само физическо преследване. Randall е важен, защото не е просто убит при възможност, а е използван като средство срещу Boyd. S04E02 goat staging се държи сходно с resource/morale intimidation, но attribution-ът остава open. S04E07 добавя Kenny като targeted emotional/operational pressure point. Не доказва, че чудовищата са всезнаещи, че имат достъп до всички човешки разговори, или че действат като единна агенция с Man in Yellow. Плановата информация в S04E07 е по-добре да се записва като `MIY/Sophia plan-sabotage -> monster/corpse countermove`, докато механизмът на координация остане неизвестен. Намерението "да пречупят Boyd" е силно подкрепено от staging-а на капана, но системната причина остава неизвестна.
...
**Наблюдение:** в S04E07 Sophia-form / Man in Yellow извършва egg/ritual-like действие върху тялото на Roger, след което мъртвото тяло се активира и влиза в Colony House context-а. Elgin спира/убива reanimated Roger body с totem/spear-like weapon.

**Увереност:** ⭐⭐⭐⭐⭐ за animated corpse event; ⭐⭐⭐☆☆ за Man in Yellow ritual като непосредствен cause; ⭐⭐☆☆☆ за механизма.

### Ограничение
Това не доказва true resurrection или завръщане на Roger като личност. Най-предпазливите варианти са puppet body, possessed corpse, animated vessel, copy/body shell или temporary reanimation. Този class трябва да се държи отделно от standard monsters, lake effigies и Smiley rebirth process-а, докато не се покаже общ механизъм.
