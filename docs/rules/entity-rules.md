...
**Наблюдение:** специални дървета могат да преместват обекти/хора. В S02E10 Bottle Tree функционира като Faraway/routing tree и отвежда Tabitha до tower/lighthouse node-а.
**Увереност:** ⭐⭐⭐⭐☆
...
### S02E10 caution
Bottle Tree вече е доказан routing node в този случай, но това не доказва, че винаги води към lighthouse-а или че хората могат да избират дестинация.
