...
| Polaroid camera / photographic interface | S03E07/S03E08 | media/instruction interface | камерата щраква/работи сама и произвежда repeated photo/action payload-и, които насочват Elgin към root cellar / hidden room, suspicious preparation и Fatima containment | source-ът kimono manifestation ли е, друг channel, средата, или неизвестен interface; снимките помощ ли са, инструкции, warning, lure или принуда? |
