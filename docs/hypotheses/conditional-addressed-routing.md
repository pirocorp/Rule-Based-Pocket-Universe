...
- S01E04 установява, че Faraway Trees могат да преместват хора/обекти.
- S02E10 показва `Tabitha + Bottle Tree -> lighthouse/tower`.
...
- **Person-dependent routing:** различни хора получават различни destination-и.
...
- Няма директно съответствие `число -> destination`.
