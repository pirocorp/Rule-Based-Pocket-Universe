...
След S04E10 пълната теза вече е по-конкретна:

> **FROM е Rule-Driven Pocket Universe с поне две opposing agencies в shared rule system; хората могат да променят system-level outcomes само когато удовлетворят правилната процедура.**

Това не означава, че всяко действие е ritual. Означава, че при structural interventions като children/bones/Bottle Tree линията може да не е достатъчно да се постигне същият видим краен резултат: actors, sequence, location, objects, route, words/sound, blood/body material и timing могат да определят причинния outcome.

След S03E10 моделът вече включва child-sacrifice origin, immortality bargain, monster rebirth и reincarnating rescuers. S04E04 добавя Man in Yellow като historical predator/actor в Victor-era massacre и подсилва self-consistent Story Walker модела чрез failed bookmark test. S04E05 добавя отделен lake/cabin effigy threat и Jade prior-incarnation memory layer, който прави social failure/human conflict част от recurring system behavior-а. S04E06 добавя physical verification за Jade hidden spatial information чрез скритата врата в Colony House basement, както и силна hypothesis, че гората може да натрупва/материализира страхове на мъртви хора. S04E07 прави entity-class diversity още по-важна: corpse reanimation, failed standard-monster totem test, Henry false-state и Fatima-Smiley residual interference показват, че rules/protections/capabilities не са универсални, а scope-нати по класове и канали. S04E09 добавя procedural / ritual causality като архитектурен слой. S04E10 добавя директна Boy in White / Man in Yellow опозиция и показва MIY да саботира prerequisites/protection infrastructure, вместо просто да отменя системата. Това не отменя Rule-Driven Pocket Universe модела; прави го модел за shared rules, opposed agency и procedure-sensitive human intervention.
