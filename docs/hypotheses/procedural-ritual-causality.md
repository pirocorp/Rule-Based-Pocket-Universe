...
- Child-sacrifice origin account-ът вече не се чете само като "децата са умрели", а като конкретен ritual, довел до immortality/bargain outcome.
- Smiley rebirth не е просто "чудовище умира -> връща се"; минава през Fatima condition, human biomaterial и kimono-mediated birth process.
- MIY egg/ritual-like action върху Roger corpse води до corpse reanimation / dead-body puppet outcome, различен от Smiley rebirth.
- Blood use cases са различни: Henry drink, Clara blood pact, Clara-to-Fatima drink sabotage.
...
- Това не доказва, че всяко събитие във FROM е ritual.
- Не знаем кои parameters са задължителни и кои са символични/подвеждащи.
...
- Дали `Tabitha + Jade` configuration произвежда различен outcome от larger group / wrong participants.
- Дали костите действително имат ward/anchor/rescue function само след конкретно изравяне/преместване.
